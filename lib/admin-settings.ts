...
export const ADMIN_SETTING_DEFINITIONS: AdminSettingDefinition[] = [
  ...
  { key: "LEARNING_FOLLOWUPS_DRY_RUN", category: "Learning Follow-ups" },
  { key: "LEARNING_FOLLOWUPS_INACTIVITY_DAYS", category: "Learning Follow-ups" },
  { key: "LEARNING_FOLLOWUPS_CAMPAIGN_MONTHS", category: "Learning Follow-ups" },
  { key: "LEARNING_FOLLOWUPS_MAX_REMINDERS", category: "Learning Follow-ups" },
  { key: "LEARNING_FOLLOWUPS_RUN_LIMIT", category: "Learning Follow-ups" },
  { key: "LEARNING_FOLLOWUPS_COURSE_ALLOWLIST", category: "Learning Follow-ups" },
  { key: "COURSE_LIFECYCLE_EMAILS_ENABLED", category: "Course Lifecycle Emails" },
  { key: "COURSE_LIFECYCLE_EMAILS_DRY_RUN", category: "Course Lifecycle Emails" },
  { key: "COURSE_LIFECYCLE_EMAILS_RUN_LIMIT", category: "Course Lifecycle Emails" },
  { key: "COURSE_COMMUNITY_WHATSAPP_URLS_JSON", category: "Course Lifecycle Emails" },
