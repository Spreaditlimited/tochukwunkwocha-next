...
export function SiteHeader() {
  ...
  return (
    <>
      <header className="fixed inset-x-0 top-0 z-[100] w-full bg-background/80 backdrop-blur-xl supports-[backdrop-filter]:bg-background/60 md:sticky">
      ...
      <details id="mobile-site-menu-shell" ref={mobileMenuRef} className="group md:hidden">
        ...
        <div
          id="mobile-site-menu"
          className="fixed inset-x-0 bottom-0 top-20 z-[90] overflow-y-auto overscroll-contain border-t border-border bg-background p-5"
        >
          ...
          <div className="mt-8 flex flex-col gap-4 border-t border-border pt-8">
            ...
            <Link href="/courses" prefetch={false} onClick={closeMobileMenu} className="btn-primary flex justify-center py-4 text-base shadow-sm">
              Explore Programmes
            </Link>
          </div>
        </div>
