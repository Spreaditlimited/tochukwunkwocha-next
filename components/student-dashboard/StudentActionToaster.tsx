...
function readCookieToast() {
  ...
  document.cookie = `${COOKIE_NAME}=; Max-Age=0; path=/dashboard; SameSite=Lax`
...
export function StudentActionToaster() {
  ...
  useEffect(() => {
    ...
    function onSubmit(event: SubmitEvent) {
      ...
      show({
        ...
        message: "Please wait while the dashboard applies this change."
      })
