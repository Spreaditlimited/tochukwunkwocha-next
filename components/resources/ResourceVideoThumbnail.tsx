...
export function ResourceVideoThumbnail({
  ...
  return (
    <div className={`relative flex aspect-[16/10] overflow-hidden bg-[#ff0000] text-white ${className}`}>
      ...
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_18%_18%,rgba(255,255,255,0.22),transparent_22rem),linear-gradient(135deg,rgba(255,0,0,0.98),rgba(135,0,0,0.96))]" />
      <div className="relative z-10 flex min-w-0 flex-1 flex-col justify-between p-5 sm:p-6">
        <div className="flex items-center justify-between gap-4">
          ...
          <span className="inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-full border border-white/25 bg-white text-[#ff0000] shadow-lg shadow-black/20">
