...
export default function PrivateCoachingSubscribePage() {
  return (
    <main className="min-h-screen overflow-hidden bg-brand-ink text-white">
      ...
      <div className="pointer-events-none fixed -left-32 -top-32 h-[520px] w-[520px] rounded-full bg-primary/10 blur-[130px]" />
      <div className="pointer-events-none fixed -bottom-32 -right-32 h-[520px] w-[520px] rounded-full bg-brand-sky/10 blur-[130px]" />

      <div className="site-container relative z-10 py-8">
        <Link href="/private-ai-build-coaching" className="inline-flex items-center text-sm font-bold text-brand-sky no-underline transition-colors hover:text-brand-sky">
        ...
        <div className="mt-10">
          ...
          <p className="eyebrow text-brand-sky">Coaching Setup</p>
